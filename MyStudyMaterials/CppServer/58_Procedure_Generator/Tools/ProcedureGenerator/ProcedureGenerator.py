...
def main():
    ...
    arg_parser.add_argument('--path', type=str, default='C:/Users/tkdri/Desktop/StudyCPPServer/MyStudyMaterials/CppServer/58_Procedure_Generator/GameServer/GameDB.xml', help='Xml Path')
