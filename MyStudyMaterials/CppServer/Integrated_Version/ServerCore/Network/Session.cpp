...
Session::Session() :socket(INVALID_SOCKET), isConnected(false), recvBuffer(BUFFER_SIZE)
{
...
bool Session::RegisterConnect()
{
    ...
    connectEvent.Init();
    connectEvent.ownerDispatcher = shared_from_this(); // ADD_REF
                                        ...
                                        sizeof(sockAddr), nullptr, 0, &numOfBytes, &connectEvent))
    {
        ...
        {
            connectEvent.ownerDispatcher = nullptr; // RELEASE_REF
            return false;
        }
    }
...
bool Session::RegisterDisconnect()
{
    ...
    disconnectEvent.ownerDispatcher = shared_from_this(); // ADD_REF
                                           ...
                                           TF_REUSE_SOCKET, 0))
    {
        ...
        if (errorCode != WSA_IO_PENDING)
        {
            disconnectEvent.ownerDispatcher = nullptr; // RELEASE_REF
            return false;
        }
    }
...
void Session::RegisterRecv()
{
    ...
    recvEvent.Init();
    recvEvent.ownerDispatcher = shared_from_this(); // ADD_REF
                                  ...
                                  OUT &flags, &recvEvent, nullptr))
    {
        ...
        if (errorCode != WSA_IO_PENDING)
        {
            ...
            recvEvent.ownerDispatcher = nullptr; // RELEASE_REF
        }
    }
}
...
void Session::RegisterSend()
{
    ...
    sendEvent.Init();
    sendEvent.ownerDispatcher = shared_from_this(); // ADD_REF
    ...
    )
    {
        ...
        {
            HandleError(errorCode);
            sendEvent.ownerDispatcher = nullptr; // RELEASE_REF
