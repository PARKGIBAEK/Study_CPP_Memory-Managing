...
class S_ENTER_GAME final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Protocol.S_ENTER_GAME) */ {
 public:
  ...
  inline S_ENTER_GAME(const S_ENTER_GAME& from)
      : S_ENTER_GAME(nullptr, from) {}
...
class C_LOGIN final :
    public ::google::protobuf::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:Protocol.C_LOGIN) */ {
 public:
...
class C_ENTER_GAME final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Protocol.C_ENTER_GAME) */ {
 public:
  ...
  inline C_ENTER_GAME(const C_ENTER_GAME& from)
      : C_ENTER_GAME(nullptr, from) {}
