...
int main()
{
	...
	{
		DBConnection* dbConn = GDBConnectionPool->Pop();
		// Input은 3개, Output은 0개(쿼리 수행 결과를 요구하지 않으므로)
	...
	// Read
	{
		...
		// Input은 1개(Select 쿼리의 gold), Output은 4개(select 결과에 대한 Column id, gold, name, createDate)
